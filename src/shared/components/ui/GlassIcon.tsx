...
const gradientMapping: Record<NonNullable<GlassIconProps["color"]>, string> = {
...
export function GlassIcon({ icon, color = "blue", className = "" }: GlassIconProps) {
  return (
    <span
    ...
    >
      ...
      >
        <span className="m-auto w-[1em] h-[1em] flex items-center justify-center text-white" aria-hidden="true">
          {icon}
        </span>
      </span>
    </span>
