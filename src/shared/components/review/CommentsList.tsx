  ...
  if (loading) {
    return (
      <div className="flex-1 bg-white dark:bg-[#0d0d0f] flex items-center justify-center p-8">
        <Loader2 className="w-5 h-5 animate-spin text-[#6893e8]" />
      </div>
    );
  }
                        ...
                        if (part.type === 'timestamp') {
                          return (
                            <button
                              ...
                              className="inline font-semibold text-[#6893e8] hover:text-[#557bc1] transition-colors mx-0.5"
                            >
                              {part.value}
                            </button>
                          );
        ...
        {isAdding && (
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              >
                {submitting ? (
                  <Loader2 className="w-4 h-4 animate-spin text-[#6893e8]" />
                ) : (
