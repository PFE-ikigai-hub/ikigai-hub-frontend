...
import { authApi, setApiRoleHeader, setAppInitializing, setLoginInProgress } from "@/core/api/client";
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = useCallback(async (email: string, password: string) => {
    ...
    // Bloque le refresh/logout automatique pendant le me() post-login.
    // Sans ce verrou, un 401 transitoire sur /api/users/me declenchait auth:logout
    // qui supprimait tous les cookies fraichement crees, causant l'echec du 1er essai.
